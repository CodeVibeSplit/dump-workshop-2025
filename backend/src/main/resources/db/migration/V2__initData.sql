...
VALUES ('What is the primary purpose of the Spring Framework?', 'MEDIUM', 'Java'),
       ('Which of the following is NOT a JavaScript data type?', 'EASY', 'JavaScript');

-- Answers for Question 1
INSERT INTO answers (question_id, text, is_correct)
VALUES (1, 'To provide a comprehensive programming and configuration model for Java applications', TRUE),
